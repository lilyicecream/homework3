...
        await axios.post('http://localhost/homework3/Controller/RestApi/Ratings/update.php/${song}', songUpdate);
        const updatedData = [...data];
        const updatedSongIndex = updatedData.findIndex(item => item.id === songId);
        updatedData[updatedSongIndex] = { ...updatedData[updatedSongIndex], song: songUpdate };
        setData(updatedData);
        setMode('display');
    }
